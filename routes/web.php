...
Route::post('appointments/add-file', [AppointmentController::class, 'addFile'])->name('appointment.add.file');
...
Route::middleware('auth', 'verified', 'xss', 'checkUserStatus')->group(function () {
    ...
    // excel export routes.
    Route::middleware('role:Patient|Doctor|Receptionist|Admin')->group(function () {
    ...
    Route::middleware('role:Admin|Receptionist|Case Manager|Doctor')->group(function () {
        ...
        Route::get('patients/{patient}/edit', [PatientController::class, 'edit'])
            ->name('patients.edit');
        Route::post('patients/history/text', [PatientController::class, 'saveTextHistory'])->name('history.text.save');
        Route::post('patients/rochet/text', [PatientController::class, 'saveTextRochet'])->name('rochet.text.save');
        ...
        Route::get('patients/{id}/history-board', [PatientController::class, 'historyBoard'])->name('patient.history.board');
        Route::post('patients/history-board/save', [PatientController::class, 'historyBoardSave'])->name('patient.history.board.store');
