...
//    protected $listeners = ['refresh' => '$refresh', 'changeFilter', 'changeDateFilter' ];
    ...
    public function columns(): array
    {
        return [
            ...
            //     ->searchable()
            //     ->sortable(),
            Column::make(__('messages.service.service'), 'department.title')
                ->view('appointments.templates.columns.service')
                ->searchable()
                ->sortable(),
            Column::make(__('messages.case.fee'), 'department.title')
                ->view('appointments.templates.columns.fees')
                ->searchable()
                ->sortable(),
            ...
            Column::make(__('messages.appointment.date'), 'opd_date')
                ...
                ->sortable(),
            Column::make(__('messages.live_consultation.created_by'), 'department.title')
            ->view('appointments.templates.columns.createdBy')
            ->searchable()
            ->sortable(),
