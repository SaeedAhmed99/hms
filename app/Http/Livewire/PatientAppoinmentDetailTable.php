    ...
    public function columns(): array
    {
        ...
        return [
            ...
            Column::make(__('messages.appointment.doctor_department'), 'doctor.department.title')->view('patients.patient_appointment_detail_column.department')
                ->sortable()->searchable(),
            Column::make(__('messages.service.service'), 'service.name')->view('patients.patient_appointment_detail_column.service')
                ->sortable()->searchable(),
            Column::make(__('messages.case.fee'), 'fees')->view('patients.patient_appointment_detail_column.fees')
                ->sortable()->searchable(),
            Column::make(__('messages.live_consultation.created_by'), 'user_entered')->view('patients.patient_appointment_detail_column.user_entered')
                ->sortable()->searchable(),
