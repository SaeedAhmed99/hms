                    ...
                    <table style="font-family: 'almarai', sans-serif;">
                        <tr>
                            <td style="text-align: center;">
                                Financial report for all doctors to day: {{ \Carbon\Carbon::yesterday()->format('d-m-Y') }}
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr class="information">
                <td colspan="2">
                    <table style="font-family: 'almarai', sans-serif;">
                        <tr>
                            <td style="text-align: center;">
                                Financial report for Dr: {{ $doctor->user->first_name }} {{ $doctor->user->middle_name }} {{ $doctor->user->last_name }}<br/>
                                Total Earning: {{ $doctor->appointments->sum('fees') }}                      
                            </td>
                        </tr>
                    </table>
                </td>
